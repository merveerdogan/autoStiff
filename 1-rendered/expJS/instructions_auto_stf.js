...
test_question = ['You just saw two videos of a cloth waving in the wind. One video showed a <i>stiffer</i> cloth, and the other showed a <i>less stiff</i> cloth. Which cloth seemed stiffer to you?<p>Click <strong>"First Cloth"</strong> below if the first cloth (the one you watched earlier) seemed stiffer, or click <strong>"Second Cloth"</strong> if the second cloth (the one you watched later) seemed stiffer.</p>'];
